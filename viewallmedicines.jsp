						...
						<c:forEach items="${sessionScope.list1}" var="l">
							<tr>
								...
								<td data-field="id3" data-sortable="true"><center><c:out
										value="${l.mdiscription} " /></center></td>
								...
								<td><center><a href="UpdateStockController?id=${l.sid}" style="color: blue;">Update</a></center></td>
								<td><center><a href="DeleteStockController?id=${l.sid}" style="color: blue;">Delete</a></center></td>
